    ...
    <div class="row">
        ...
        <div class="col-xl-4 col-lg-5">
            ...
            <div class="mb-4 shadow card">
                ...
                <div class="card-body">
                    <div class="pt-4 pb-2">
                        <img width="180" src="{{ asset('assets/images/img1.svg') }}"
                    ...
                    <div class="pb-2">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                    ...
                                    <div class="pb-2">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="exampleInputEmail1"
                                                name="idpengenal" placeholder="Ketik ID (Sesuai Pilihan di atas) Disini"
                                                required>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">NAMA</label>
                                            <input type="text" class="form-control" id="exampleInputEmail1"
                                                name="nama" placeholder="Nama Lengkap Tanpa Gelar" required
                                ...
                                <input type="text" class="form-control" id="exampleInputEmail1" name="idpengenal"
                            ...
                            <div class="form-group">
                                <label for="exampleInputEmail1">TEMPAT LAHIR</label>
                                <input type="text" class="form-control" id="exampleInputEmail1" name="tempatlahir"
                                    required>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">TANGGAL LAHIR</label>
                                <input type="date" class="form-control" id="exampleInputEmail1" name="tanggallahir"
                                    required>
                            </div>
                        ...
                        <<<<<<< Updated upstream <div class="card-body">
                            <div class="pb-2">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputEmail1" name="warganegara"
                                        placeholder="Ketik Asal Negara Anda" required>
                                </div>
